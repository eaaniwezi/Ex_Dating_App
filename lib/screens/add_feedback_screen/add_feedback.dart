...
import 'package:dating_app/widgets/custom_auto_complete_text_field.dart';
...
import 'package:dating_app/widgets/text_with_switch.dart';
import 'components/expanded_bordered_container.dart';
                ...
                child: ListView(
                  children: [
                    ...
                    ExpandedBorderedContainer(
                      isMaximizedContainer: appStates.isMaximizedContainer,
                      childrenMinimized: [
                        Row(
                          children: [
                            SvgPicture.asset(
