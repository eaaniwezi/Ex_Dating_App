                        ...
                        icon: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: UserRepository.user?.avatar_url != null ? NetworkingService.getImage(AppEndpoints.imageUrl + UserRepository.user.avatar_url) : AssetImage(Lists.profilePhotoEmpty),
                            ),
                          ),
                        ),
                      )
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(30),
                  image: DecorationImage(
                    image: AssetImage(Lists.profilePhotoEmpty),
                  ),
                ),
              ),
              SizedBox(width: 13),
