...
//
  ...
  static final String imageUrl = 'http://185.87.50.207/';
  ...
  static String userById(int id) => '$baseUrl/user/$id';
  static final String country = '$baseUrl/country';
  static final String changePassword = '$baseUrl/user/password';
  static final String mySubscribers = '$baseUrl/subscribers/my';
  static String subscribeID(int id) => '$baseUrl/subscribe/$id';
  static String unsubscribeID(int id) => '$baseUrl/unsubscribe/$id';
  ...
  static final String topUsers = '$baseUrl/user/top';
  static final String mySubscriptions = '$baseUrl/subscribers';
