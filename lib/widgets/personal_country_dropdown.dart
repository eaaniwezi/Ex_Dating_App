...
class PersonalCountryDropdown extends StatefulWidget {
  ...
  PersonalCountryDropdown({this.text, this.controller, this.onChanged, this.hintText, this.selectedItem});

  @override
  _PersonalCountryDropdownState createState() => _PersonalCountryDropdownState();
}
