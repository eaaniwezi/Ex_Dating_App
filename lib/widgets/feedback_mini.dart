        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  width: context.mediaQuerySize.width,
                  height: widget.allFeedback.user.avatar_url != null ? 205 : 155,
                  child: Stack(
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: ((widget.allFeedback.images?.length ?? 0) > 0) && widget.allFeedback.images[0] is String
                              ? Image(
                                  image: NetworkImage(AppEndpoints.imageUrl + widget.allFeedback.images[0]),
                                  width: context.mediaQuerySize.width,
                                  fit: BoxFit.fitWidth,
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  ...
                                  fit: BoxFit.cover,
                                  image: NetworkImage(AppEndpoints.imageUrl + widget.allFeedback.user.avatar_url),
                                ),
                              ),
                            ),
                          ),
